      ...
      <v-card-text>
        <v-container>
          <v-layout align-start justify-center column>
            ...
            <v-flex xs6><h3><span class="grey--text">格言作者 : </span>{{dData.author}}</h3></v-flex>
            <v-flex xs6><h3><span class="grey--text">格言来源: </span>{{dData.source}}</h3></v-flex>
            <v-flex xs6 style="margin-left:20px;" v-html="dData.content_html">
            </v-flex>
          </v-layout>
        </v-container>
      </v-card-text>
